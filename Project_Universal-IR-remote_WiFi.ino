...
char ssid[] = "ADDOIL ONLINE";            // your network SSID (name)
char pass[] = "0832252245";        // your network password
...
void sendCode(int repeat) {
  ...
  }else if(storedButton[pointer].decode_type == LG){
    irsend.sendLG(storedButton[pointer].value, storedButton[pointer].bits);
